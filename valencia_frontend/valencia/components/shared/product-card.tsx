...
export const ProductCard: React.FC<Props> = ({
  ...
  return (
    <>
      <div className={className} onClick={handleCardClick} style={{ cursor: 'pointer' }}>
      ...
      {modalOpen && !isMobile && (
        <ProductModalSecond
          product={{ id, name, price: price.toString(), image: imageUrl, description: ingredients, category: '' }}
